...
class PPRankExpiredEvent final : public ll::event::Cancellable<ll::event::Event>
{
    ...
    PPGroup& mGroup;
public:
    constexpr explicit PPRankExpiredEvent(Level& level,Player& player,PPGroup& group) : mLevel(level),mPlayer(player),mGroup(group) Cancellable() {}
...
class PPRankChangedEvent  final : public ll::event::Cancellable<ll::event::Event>
{
    ...
    Player& mPlayer;
public:
    constexpr explicit PPRankChangedEvent (Level& level,Player& player) : mLevel(level),mPlayer(player), Cancellable() {}
    LLNDAPI Level& level() const;
    LLNDAPI Player& player() const;
