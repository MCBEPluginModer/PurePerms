...
public:
    ...
    virtual void setGroupData(PPGroup& group, tuple<string,bool,vector<string>,vector<string>,YAML::Node>& tempGroupData) = 0;
    virtual void setGroupsData(unordered_map<string,PPGroup> data) = 0;
